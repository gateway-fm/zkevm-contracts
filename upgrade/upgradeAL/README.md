...
```
cp ./upgrade/upgradeAL/upgrade_parameters.json.example ./upgrade/upgradeAL/upgrade_parameters.json
```
...
```
npx hardhat run ./upgrade/upgradeAL/upgradeALV3.ts --network sepolia
```
