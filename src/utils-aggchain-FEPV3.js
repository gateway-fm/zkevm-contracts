 ...
 * @param {Boolean} useOwnedGateway use owned gateway
 ...
 * @returns {String} encoded value in hexadecimal string
 */
function encodeAggchainDataFEP(aggChainSelector, outputRoot, l2BlockNumber) {
    return ethers.AbiCoder.defaultAbiCoder().encode(
        ["bytes2", "bytes32", "uint256"],
        [aggChainSelector, outputRoot, l2BlockNumber]
    );
}
